...
namespace FashionShop.Application.ProductService
{
    public interface IProductService
    {
        ...
        Task<ProductResponseDTO> CreateProductAsync(CreateProductDTO product, CancellationToken cancellationToken);
